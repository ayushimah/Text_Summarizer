...
# rank_max is the largest score value(the score of first element)
# rank_min is the smallest score value(the score of last element)
...
model = sentence_list
print('Lines is the summary: {}'.format(len(model)));
